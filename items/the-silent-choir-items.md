...
*Seat alignment: **Song and Silence** (`mythology/seats.md`), confirmed — Drew's direct call, following from Fermata's own confirmed Echo status. Which stage of Alignment Fermata itself has reached stays open on purpose, same register as Aege's own unresolved stage, but the Seat this Ring answers to is no longer a candidate. A ring that isolates one target from everyone trying to help them is a small, personal version of the same silence the room itself performs at scale — the Choir keeps the world out; the Ring keeps a person alone. Scoped to a single enemy, once per combat, and doesn't touch the target's own actions — real, but bounded, matching how Cord of the Held and the Quiet Index (`items/capital-items.md`) both stay narrow rather than open-ended.*
