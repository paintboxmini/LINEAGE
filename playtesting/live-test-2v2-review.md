...
**ROOTED OATH's Anchored Effect is a strong, currently uninterruptible engine.** Grants Deadly to an ally every turn the caster stays anchored — Sky was getting a fresh Deadly roll basically for free every cycle once Crimson cast it, and nothing in Garnet's hand could force a reposition to break it. Not necessarily broken, but worth a second look: a payoff that compounds for free with no answer available in this specific matchup is exactly the shape of thing that reads fine in isolation and ugly at the table.
