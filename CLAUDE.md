...
- **Release** — full verification: acceptance tests, print sheets regenerated, ledger empty. The combat simulator is a separate instrument Drew consults on his own schedule, not a checklist item — see `agent-tools/heuristics.md`.
