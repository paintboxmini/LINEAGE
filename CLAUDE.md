...
## Active Reasoning — Current Findings

These are living conclusions, heuristics, and findings currently being used to evaluate or improve the design. They are not a transcript; when a finding becomes fully absorbed into canon or is no longer useful as active guidance, archive it with its reasoning trail.
