...
- **Is the Seat of Death Empty, or merely unbearered-and-unknown?** `mythology/seats.md` previously said *"unbearered"* while `world/seats-archons-echoes.md` said the bearer is *"not publicly known."* These are different claims: an **Empty** Seat means "that part of reality begins breaking down — endings stop concluding," and nothing in canon suggests that is happening. Wording harmonised to "no bearer is known" during the 2026-08-02 consolidation, which both readings support, but the substantive question was deliberately not decided. **Authority 3.** *Trail: memory.md, the consolidation entry.*
