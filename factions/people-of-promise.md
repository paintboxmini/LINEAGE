...
**Why Glasslight specifically drifted this way:** the congregation has its own answer, whether or not it holds up to scrutiny. They point to the light-dance over the Soft Edge (`locations/glasslight-reach.md`, The Soft Edge) — something that drifts and folds and never finishes forming, visible from the same water the bather descends into — and read it as a sign that the Unheld doesn't only complete, it can transform and give back. Nobody outside Glasslight bathes the living at all. The justification is as local as the custom it justifies — a light nobody else can see, explaining a practice nobody else does.
