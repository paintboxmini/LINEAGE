...
**Farming** — probable first Skill. Irrigation, drainage, reading soil by feel, the vocabulary Briarwatch already speaks (`places/briarwatch.md`). The irony is on purpose: something sent to learn a world well enough to help consume it, learning instead how to grow something and let it be what it is.
...
**AMALGAMOUS FORM** — `experimental/passives.md`. Liquid metal, reshaped on demand; Blue, Both range, d4.
...
- Second Skill (Farming is the first)
- Price
