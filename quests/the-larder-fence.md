...
**The turn against the Tollbirds themselves:** Pull a perched Tollbird down off its post and onto its own wire — on the party's timing, not its own — and for once, the barbs belong to them.
...
**The larder:** whatever the fence is holding — the everyday catch (see Setup), the stray Fenwool, coins and a buckle and a hand mirror worked in among the drying bodies. And, hanging further along, the thing that shouldn't be here at all: a Skeinwing (`bestiary/skeinwing.md`) — a wingspan too wide for the wire, a membrane too blue to be anything born on the ground. Nobody at this fence has ever seen one alive; that's the point.
