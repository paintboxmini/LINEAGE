...
4. Terrain has teeth: forced positioning can hurt, and it doesn't care whose side you're on.

---

## Setup

There is no farm out this far, and no fence a farmer built. Briarwatch keeps its fields and its livestock well back from the Turnroot border — this stretch is past all of that. What stands here runs taller than a person: a plain stone-cored perimeter under decades of bramble — old work, nobody remembers whose. The thorns tell a different story than the stone, though: wrong-sized, some as long as a finger, hooked back like fishhooks, built to *hold* what they catch rather than just cut it, worked into the wire in layers that don't match the posts' clean lines. Watch a Shrike return with more brush in its claws and the question of who's been doing that answers itself. Hung along it: something small and rust-furred, a young jackalope, something with a collar — small things, prey nobody would notice going missing. All of it placed, spaced, drying. Describe the barbs before the bird — two fenceposts up, a pale shrike the size of a dog tilts its head at the road, and it is the smallest dangerous thing here.
