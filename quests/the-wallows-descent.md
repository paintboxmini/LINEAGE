...
A Tales Untold adventure structure. Experimental content. For location context, see `places/capital/the-wallows.md`. For the Demon Court, see `factions-and-races/demon-court.md`.

---

## Tone

Two dungeons in sequence. The first is tense and human — masks, chains, the smell of labor and fear. The second is quiet and wrong in a way that gets harder to name the deeper you go. The danger in the upper layer is being caught. The danger in the lower layer is forgetting why you came.

---

## Opening Conditions

The party enters the Wallows through the Underground Tavern floor — a guarded shaft, Initiates on checkpoint. They have a reason to go down. The reason shapes everything else.

**Emergent objectives — whatever fits the table:**
...
### Track 1 — Demon Court Awareness (Upper Wallows)

Measures how aware the Demon Court is of the party's unauthorized presence. Never announce a number. Narrate symptoms.

| Level | State | Symptoms |
|-------|-------|----------|
| 0 | Undetected | Initiates bored at checkpoint. Guards on routine. Prisoners moving. |
| 1 | Uneasy | A guard heard something. Extra glance down a corridor. Patrol timing tightens. |
| 2 | Alert | Guards communicating. Prisoners being counted. Direwolves brought to the main corridor leashed. |
| 3 | Active Search | Direwolves released into branches. Overseers moving. Prisoners locked in place. |
| 4 | Lockdown | All branch entrances sealed. Overseers positioned at corridor intersections. No one moves without escort. |
| 5+ | Pazuzu Mobilizes | The Warden leaves his court. He knows something is in his mine. He is not hurrying. He doesn't need to. |

**Awareness rises by 1:** combat in earshot of a guard, a prisoner cries out, a checkpoint is bypassed too loudly, a guard is incapacitated and discovered, a direwolf catches a scent and pulls.

**Awareness drops by 1:** players successfully misdirect a guard, calm a prisoner, seal off a disturbance before it spreads. Drops only by deliberate action — never passively.

**How it feels at the table:**
- Early: *"Someone's listening."*
- Mid: *"They know something's wrong. They don't know what yet."*
- High: *"The dogs are loose."*
- Critical: *"Pazuzu is coming and he is in no hurry."*
...
| Level | State | Symptoms |
|-------|-------|----------|
| 0 | Surface | Warm. Faintly pleasant. Easy to ignore. |
| 1 | Noticed | A party member mentions the warmth. Echoes are audible but distant. |
| 2 | Softening | Direction feels less certain. One party member pauses without knowing why. Echoes are recognizable. |
| 3 | Dissolving | A party member doesn't want to move. They aren't afraid — they feel fine. That's the problem. Echoes say names. |
...
**The hidden rule:** The Seat's nature is love — binding, holding, wanting closeness. Moving *with* it means moving slowly, acknowledging the echoes, accepting the warmth without fighting or feeding it. Moving *against* it — forcing, rushing, striking out — costs the party. Players who figure this out will feel it in the track. Players who don't will feel it differently.

**The dilemma at 3+:** Pulling a dissolving companion back toward the party raises the track by 1. Aurora doesn't want them to leave. The party has to decide what that's worth.

---

## The Upper Wallows — Prison Layer

### Entry Shaft

Down from the tavern floor. A rope-and-pulley system, stone walls, the sound of distant labor rising up.

Two Initiates on checkpoint. Yellow masks. The younger one is clearly nervous. The older one is performing not being nervous.

*Tactical note: the Initiates are the lowest threat in the mine and both know it. They can be bluffed, bribed in swines, or bypassed entirely if the party finds another way down. A loud confrontation here starts the awareness track at 1.*

---

### The Main Corridor

The spine of the labor level. Dead-end branches extend off it at irregular intervals — each one a sealed work tunnel. Chain whip guards stand at each branch entrance, facing inward toward the prisoners, occasionally turning to check the corridor.

The prisoners are visible through the branch openings. They're working. Most of them don't look up.

**Movement through the corridor:** players need to cross from branch to branch without catching a guard's attention. The guards have patrol rhythms — not random, but irregular enough to require watching.

**Prisoners as variable:** a prisoner who recognizes someone in the party, or who spots an unfamiliar face, may react. Not necessarily by alerting the guards — but eye contact is its own risk.

---

### The Overseer's Round

An Overseer moves through the main corridor on a slow circuit. Heavily armored. No weapon. They stop at each branch entrance, observe, move on.

They don't speak to the chain whip guards. The guards straighten when the Overseer passes.

*The Overseer is the most dangerous mobile element in the upper layer — not because they fight, but because their circuit is long and their attention is patient. They will notice what a guard might miss.*
...
Pazuzu holds audience here when he isn't making rounds. Two chain whip guards flank the entrance at all times.

**If the party confronts him:** Pazuzu is not a fool. He will not fight the party himself at low awareness levels — he will talk, stall, and send for backup. At high awareness, when he's already mobilized, he is dangerous and angry and the masks on the wall have a meaning the party is about to understand.

*The court is optional. Players who need to go through it have made the run harder. Players who avoid it entirely have made the right call.*
...
The warmth arrives before the door is fully open. Not heat — something without a source. The air is the same temperature. The warmth is somewhere else.

The passage slopes downward. The stone here is different — smoother, as if worn not by water but by wanting.
...
A wide chamber where sound doesn't leave. Every footstep is still here. Every word.

Players who speak will hear their own voices layered over older voices. Some of those voices are recognizable. Some are not. At Influence 2+, a player may hear their own name in a voice they know.

**The record:** the rescue attempt is in this room. Fragments of it. Kess's voice. Giblets'. Something that stopped mid-sentence. The GM decides how much to surface and when.

*Navigation note: the echo cavern disorients direction. Players without the grandmother's map must make a Mind check to identify the correct exit passage. Failure doesn't trap them — it costs time, and time raises Influence.*

---

### The Slime Gallery

A long passage where the walls are wet and warm and the slimes have gathered.

They don't attack. They move toward the party slowly, reaching. Getting enveloped is not violent — it is warm and still and the player inside can hear their own heartbeat very clearly.

**Enveloped:** the player is held, not harmed. Extracting them is possible. If the party does it gently — slowly, deliberately — no Influence rise. If they do it with force, Influence rises by 1. The slime releases without resistance either way. It simply wanted to be close.
...
- `factions-and-races/demon-court.md` — Pazuzu, guard hierarchy
