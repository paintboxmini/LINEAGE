...
*A Tales Untold adventure module — the first job at Vulture's Nest. Location context is `places/vultures-nest.md`; the scene that starts it is written beat by beat there, under The Opening Scene.*

---

## Tone

Nobody is lying. Nobody is a villain. Every person here is doing the reasonable thing from where they are standing, and the sum of all that reasonableness is a port that has stopped working and a hold full of people nobody can ask a question.

The horror is administrative, and the thing that makes it unsolvable is not malice. It is that **there is no way to find out**, and everyone is behaving correctly in the absence of an answer.

---

## What Is Actually True — GM Only
...
**He is also aware, every hour, that he is starving people over a guess**, and that is the pressure he is under. He does not enjoy it and will not be talked out of it by anyone who cannot give him something better than an opinion.
...
Held, not mistreated. **He speaks the common tongue**, which is why he is the one being questioned and why he is the only crack in the wall.
...
**Nobody at the Nest knows where Pneum is.** Not Bartho, not Jonas, not the Compact, not a single pilot on that water. The congregation does not trade and has never needed anyone to know.

Two ways it comes loose, and either is fine:

- **Found aboard the barge.** A chart in the crew's own marks, one island circled, unlabelled — because why would you label your own home.
- **Given.** Once the crew can speak to each other, or once Corvel decides the party are the people he was waiting for, it is handed over willingly. **This is the better version**, because it makes the map a decision somebody made about the party rather than a thing they took.

Either way it is marked, and the island is a morning's crossing northeast (`places/pneum.md`).
...
**The encounter.** Six frightened dockworkers, **Mind 1 / Body 1 / Soul 1, HP 6 each** — against three starting characters that is a coin flip (`rules/gm-guide.md`, How many of them). Four is a fight the party wins and remembers; eight is a wipe. Scale by adding neighbours, not by making them tougher.

**It is deliberately not a monster.** The hardest fight in this adventure is a crowd that has decided to solve the problem itself, and every one of them is somebody the party bought fish from that morning.

**Losable in the useful direction.** Talk them down, block the gangway, wake Bartho, buy them off, or stand in front of it. **If the party wins by hurting six locals they have solved tonight and made every later conversation in this town harder** — and Bartho will not say a word about it. He will simply be different afterwards.
...
**Somebody burns it.** The mob succeeds, or a party member decides the mob is right. This resolves the Compact's problem completely and permanently and is the only ending nobody in the town objects to, which is the most damning thing about it.
