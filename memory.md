...
**Mirel / Steve / Pip / Kaine** (`experimental/mirel.md`, `experimental/steve-and-pip.md`, `experimental/kaine.md`)
Two story arcs in development. Mirel: Promise-raised, doubting the inevitable return, found the Masons by dreaming about stabilization glyphs and scratching one from memory — a Mason handed her a chisel. Secretly learning constraint magic. Central to the Tide Pulls Back adventure. Steve: Kaine cult initiate, vanilla yes-man, does something foolish in Mirel's arc. Pip: bubble dragon formed from Steve's consciousness during ritual bathing, slowly pops over a week, causes people to flock to Steve as pseudo-Messiah, fallout when Pip is gone. Kaine: leader of The Final Current (radical Promise sect, accelerated dissolution). Has a resonant item aligned with the Storm Seat — unstable, dangerous. Uses it to perform signs and wonders he attributes to the Unheld's blessing, cementing authority within his sect. Mid-term goal: absorb the entire People of Promise community across Eclipsera through doctrine, not violence. Long-term: larger ambitions beyond the Promise community. Adventure structure is ready to write. Storm Seat confirmed as valid (Seats file is not exhaustive).
