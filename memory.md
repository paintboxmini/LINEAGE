...
**Mirel / Steve / Pip / Kaine** (`experimental/mirel.md`, `experimental/steve-and-pip.md`, `experimental/kaine.md`, `experimental/lightning-loop.md`)
Two story arcs in development. Mirel: Promise-raised, doubting the inevitable return, found the Masons by dreaming about stabilization glyphs and scratching one from memory — a Mason handed her a chisel. Secretly learning constraint magic. Central to the Tide Pulls Back adventure. Steve: Kaine cult initiate, vanilla yes-man, does something foolish in Mirel's arc. Pip: bubble dragon formed from Steve's consciousness during ritual bathing, slowly pops over a week, causes people to flock to Steve as pseudo-Messiah, fallout when Pip is gone. Kaine: leader of The Final Current (radical Promise sect, accelerated dissolution). Has the Lightning Loop — Storm Seat resonant ring, doesn't fit his finger, lightning only, can point not fully control. Uses water trick (finger in water, fizzes, heals 1 HP) as Unheld miracle for his followers. True power: hostile lightning storm. Mid-term goal: absorb entire People of Promise community across Eclipsera through doctrine. Long-term: larger ambitions. Adventure structure ready to write. Storm Seat confirmed as valid (Seats file is not exhaustive).
