...
**Balance philosophy locked in (Drew):** red's combat power is INHERENT — don't fight it. Balance via card EFFECTS: green and blue must have stronger effects than red to pay for less damage. Blue's average card is the weakest — raise the floor by buffing under-powered blue/green EFFECTS (targeted, no systemic side effects), not dice or stats.
