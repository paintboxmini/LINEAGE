...
Two story arcs in development. Mirel: Promise-raised, doubting the inevitable return, found the Masons by dreaming about stabilization glyphs and scratching one from memory — a Mason handed her a chisel. Secretly learning constraint magic. Central to the Tide Pulls Back adventure. Steve: Kaine cult initiate, vanilla yes-man, does something foolish in Mirel's arc. Pip: bubble dragon formed from Steve's consciousness during ritual bathing, slowly pops over a week, causes people to flock to Steve as pseudo-Messiah, fallout when Pip is gone. Kaine: leader of The Final Current (radical Promise sect, accelerated dissolution). Wants a resonant item aligned with the Storm Seat — unstable and dangerous. What he intends to do with it: open. Don't write the adventure structure until Kaine's goal for the item is locked. Storm Seat confirmed as valid (Seats file is not exhaustive).
