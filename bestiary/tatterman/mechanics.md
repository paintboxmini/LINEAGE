...
**Cards:** `cards/facing-you-now.md`, `cards/two-poles.md`, `cards/no-face.md`
...
**Tactical Purpose**
Free repositioning means it is never out of range and never caught out of position, which sounds worse than it plays — Body 1 and eight HP mean it dies to almost anything that connects. The problem is connecting on the turn you planned to.
