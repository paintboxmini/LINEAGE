# Briarbound — Mechanics

**Cards:** `cards/the-easiest-shape.md`, `cards/close-the-tangle.md`, `cards/thornfast.md`
...
At distance and in poor light a Briarbound reads as a person standing in a field. A party that has not identified it — Senses or Reason, DC 13 — gives it the first attack of the encounter as an ambush: it auto-hits, no RPS, no defense, and neither Evade nor Immunity applies (`rules/combat.md`, Stealth & Ambush).
