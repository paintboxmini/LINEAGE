...
- `bestiary/the-first-bundle/README.md` — the oldest one, and what the winters have been going to
- `places/briarwatch.md` — the fields, the fences, and the Masons' line
- `bestiary/fenwool/README.md` — the animal a Haywight's wool was sheared from
