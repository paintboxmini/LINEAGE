...
**Two pill-shaped patches of bare skin on each side of the neck.** Hairless, swollen, red. On a resting animal they are slack and dark. They are what the name is for.
...
**Territorial, and everything else follows from it.** A troop holds a stretch of rock and knows it in a way nothing passing through ever will. They are not hunting you. **You walked in.**

**There are lookouts.** Somebody is always up and watching, and the troop's whole posture assumes it. *This is what the warning call was always for* — the file said the call is aimed at the others on the rock, and the others on the rock are a troop with a sentry.

### The encounter, as it actually runs

1. **A lookout sees the party before the party sees anything.** They are the colour of the rock and they were already there.
2. **The neck swells and the call goes out.** This is the only warning, it is not aimed at the party, and it is the moment the party gets to decide something.
3. **The lookout starts throwing immediately.** Alone, from above, from cover, at range — it does not wait for help before it starts, it waits for help *while* it works.
4. **Backup arrives, and keeps arriving.** The fight gets bigger every round the party stays in it.

**Which makes the clock the encounter.** The first exchange is one animal at range and perfectly survivable. The fifth is a troop. A party that treats the opening as an easy fight is choosing the hard one without noticing.

### The way out is to leave

**A territorial animal wants you gone, not dead**, and that is the whole release valve. **Back off down the slope and it stops** — no pursuit worth the name, no grudge, and the rocks quit landing once the range opens. Nothing about the troop requires the party to win.

*Which is the version worth running.* A fight you cannot win and were never required to win, that announces itself before it starts and lets you out at any point, is a much better encounter than a wall of hit points — and a party that reads the neck, understands the call, and backs down the scree has been taught how this country works without anybody explaining it.

### And it is why the odds line matters

They do not flee from a fight they are in — *because they are not in a fight they did not choose to be in.* You came to them, there are more of them arriving, and they know the ground. **When the odds genuinely turn, they leave**, and a troop that is losing goes up the rock and is simply gone.

## The Spurs

**A paralytic**, and the anatomy says what kind: the spurs are on the backs of the legs, they go into somebody who has closed with them, and **what stops working is your legs.**
...
*(Distinct from **Future-Lock**, the Weald's wasp venom, which takes hand size instead — `bestiary/future-lock-wasp.md`. Two paralytics, two different things going numb, no overlap.)*
