...
Where the Unheld presses close, things become harder to Name, harder to hold, harder to keep.

---

## How People Understand It

**To the masses:** It is grey water. Mysterious and a fact of life. You don't sail it. You don't fish it. You don't speak of it often. It is simply there, at the edges, as it has always been. The edge of the world.
...
**To the People of Promise:** It is infinite potential, not threat. The origin of all things and their destination. "The Promise" — the belief that everything eventually returns to the Unheld — is the foundation of their entire philosophy. See `factions/people-of-promise.md`.

---

## Geography

The Unheld Ocean surrounds the known world entirely. Nothing crosses it. The continent's strong sailing culture lives entirely on the web of rivers and lakes — river sailors are common and valued; ocean sailors do not exist.

**The coastline is the threshold.** The Unheld ends where the land begins. Inland water is just water. Whatever the Unheld is, it does not travel upstream, and it cannot be carried. Grey water scooped at the coast and walked inland arrives as ordinary water.

Glasslight Reach sits at the northernmost edge of the known world, where the Unheld is white and foaming, leeching color from the air above it.

Only two kinds of people interact with the Unheld at all. The Glasslight light-cartographers map its edge — the edge, never the water — recording hues and distortions in atlases that are half survey, half scripture. Precision is the risk, not just proximity: an instrument-accurate rendering courts the same danger as standing too close, since it asks the eye to treat it as the real thing. A looser, interpretive hand — a painting, not a survey — doesn't carry that risk the same way, no matter how skilled (`places/glasslight-reach.md`, The Gallery). And the People of Promise break the one convention everyone else keeps: they touch it on purpose. See `factions/people-of-promise.md`.
