...
They failed before any of that mattered. Aurora already held the Seat, and ambition doesn't empty a chair that isn't empty. The attempt still left marks on everyone in the room — reaching for a Seat's power without becoming its Archon is its own kind of damage, already accounted for elsewhere (`mythology/echoes.md`, Stage III proximity without Incarnation, cited below) — but whatever they'd actually intended to build with that power never got attempted at all.
