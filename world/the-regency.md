...
Before the Regency existed, there was a party. King Pendragon and seven companions — one of them his own brother, Oswald — attempted to claim the **Seat of Love/Binding**, the Seat Aurora occupies. The stated purpose, the one history recorded, was unity: end the factional wars, bind the peoples of Eclipseria under a shared principle.

**The real purpose (GM Secret, known only to the eight who were in the room) was narrower and far more dangerous: a permanent binding.** Pendragon as ruler, Eclipseria as a kingdom, bound perfectly and forever. Not a bypass of Price — nothing bypasses Price; the Second Cut is explicit that it can't be done (`world/creation-myth-the-three-cuts.md`: *"The Cuts have never stopped bleeding. They cannot — healing would close them, and a closed wound holds nothing open"*) — but a Seat powerful enough to bind a domain perfectly doesn't need to bypass Price to look, for a very long time, like it has. **Binding and Holding are not the same thing.** A Seat can bind a domain completely; that doesn't stop the debt for holding it from accruing, only stops anyone from paying it as they go. Attempted this way, Price doesn't vanish — it accumulates, whole, until it's called in all at once instead of piecemeal. A Haven that stops being paid for goes back gradually, sometimes over years (`world/the-in-between.md`, Havens). A Binding attempted like this doesn't fade the same way. It's unmade entirely, in a single stroke, kingdom and all. Eight people reached for something that could genuinely have worked, in the narrow sense of *binding* — and would have ended in something far worse than an ordinary failure if it had.

They found her first. Research, not luck — whatever it actually took, the eight of them worked out that the Seat of Love/Binding was occupied, and by whom, before they moved on anything. Only once they knew did the real plan take shape: not displacing Aurora from the Seat, but binding the domain permanently *through* her, using her as the anchor. They built the site for it in advance — a throne raised into a great loom, meant to carry the ritual's full weight — then took her there themselves, by force, to begin it. Nobody now living knows how they found her identity out; that part of the record didn't survive whoever kept it.

The ritual didn't survive contact with her. Whatever theory the throne was built around, Aurora fought back the moment she understood what was being done to her — eight people, a King among them, against an Archon, the exact fight **Contested** describes (`world/seats.md`, Seat States: "two beings fighting for a Seat warp reality until one wins"). That fight *is* the Pendragon Attempt, breaking out in the middle of the ritual, not in place of one. It killed two of them outright and nearly finished the rest, which is exactly why the Seat has stood Contested for a hundred years instead of settling back to Filled. The marks are what surviving it looked like: reality warping through eight people locked in combat with a being who *is* the pattern her domain runs on, at the exact moment they were trying to bind her to a structure she'd never agreed to. (`world/resonant-people.md`, Stage III proximity without Incarnation, is the mechanical shape of that damage — the fight itself is the plain truth of what happened.)

They broke off because it was killing them, not because they'd lost outright — and what came after wasn't a lesser consolation for a Binding they'd given up on. **It never stopped.** A direct confrontation had nearly killed all of them; what they built instead was patient — chain her to the throne they'd already raised, and grind the Contested fight down slowly instead of losing it fast a second time. The extraction that became the Weavers' Grid a century later reads, on the surface, as civic power (`factions/the-weavers.md`). Underneath, it's the same fight the original eight lost outright, still running, one thread at a time — wearing Aurora's resistance down instead of overpowering it, until Contested finally settles into something total and permanent: Bound, not merely held, and never fought over again. **Aurora, permanently bound. Pendragon's kingdom, eternal — that was always the goal, and it never changed. Only the timescale did.**

The council's own justification, the thing that lets five people live with a century of this, is that binding *is* what her domain already is. Forcing her toward total Binding reads to them as an act aligned with her own nature, not against it. It doesn't hold up. What actually modifies Price is alignment with a seated Archon's *will* (`world/archons.md`, An Archon's Will Shapes Price) — a Seat's domain has no preference of its own to align with; only the person seated in it does. Aurora's will is not on their side. She was taken to that throne by force and has spent a century fighting exactly what they're doing to her — Contested *is* what acting against a seated Archon's will looks like, the whole time it's been running. There is no discount hiding under the justification. It's a comfortable mistake, not a technicality, and comfortable mistakes are what let five people keep doing this for a hundred years instead of calling it what it is.

What none of the eight understood the day of the fight, and what took decades of watching the throne and the city change to become clear, is that a century of unbroken contact with a living Archon doesn't only wear a domain down — it builds something alongside the wearing-down. The Loom reached its own Embodiment. The capital reached its own Hallowing (`world/seats.md`, Love/Binding). Nobody set out to cause a convergence. By the time anyone still walking from that first fight recognized what a century of extraction had actually built, it was most of the way finished — not planned into the original attempt, but understood well before now, and deliberately given room to keep completing ever since.

**What the failure did:**
- Two of the seven companions died in the fight outright — the first Owl, the first Panther. Their seats didn't go with them; they had to be filled.
- Each surviving member lost internal contradiction. What burned away first was specifically the part of them capable of loving anyone the way they had before the fight — not warmth in general, the Seat's own domain, taken from the people who tried to take it. What's left is duty, function, the shape each was already leaning toward — archetypes, not people. The animal masks are scar tissue, not heraldry. Pendragon's version of this same wound, taken all the way instead of partway, is what made him the Scar (below) — the five didn't escape what he didn't survive. They took a smaller dose of it and kept walking.
- **They know they are paying for what they did. They do not see what they have become paying it.** They perform their old friendships and their old offices out of duty and habit, the shapes of a court that used to mean something, without the feeling that used to justify any of it. The century since is the visible result — a capital that runs correctly, held together by people who no longer feel the thing they're supposedly protecting, extracting a domain from its actual bearer that none of them can fully feel either (`world/seats.md`, Love/Binding — the same Binding-without-Love split, at civic scale, that the Regency's own founders are quietly living out at a personal one).
- **What the missing feeling looks like in the offices they actually hold:** security that profits from the crime it exists to remove (Archibald), justice that serves whoever's paying instead of whoever's right (Isabella). Different domains, same absence underneath both — neither of them has enough left to actually love the people the office was supposed to protect.
...
- They are all failed Seat-takers. See `world/resonant-people.md` (Stage III proximity without Incarnation — the most unstable form).
...
**What he's actually working toward is a second plan the other four have never heard of, built quietly on top of the one all five of them share.** The shared plan — Aurora permanently bound, the kingdom eternal, never fought over again — is real, and Oswald has spent a century supporting it exactly as openly as the other four have. **Removing Aurora was never part of the deal the five of them struck, and the other four would not approve of it if they knew.** Somewhere across a hundred years of studying what he'd actually helped build, Oswald found something none of the others went looking for: that taking Aurora out of the Seat entirely — not binding her further, removing her — might open space for his brother to be remade. Made whole again. Not a theory he could defend to the others. A hope he has never once let go of since he found the thread of it.

**What he has never let himself examine is what fills the space she leaves.** A convergence is already locked onto this Seat — the Loom Embodied, the capital Hallowed, only the person-ladder still occupied and Contested. Take the occupant out, and what a convergence like that most likely needs next isn't an empty chair. It's a new one to sit in it. If Oswald's private plan ever worked exactly as he pictures it, his brother wouldn't be handed back a free throne — he'd be fused to the Loom the same way Aurora is now, the kingdom's new permanent anchor, not its returning king. Nobody is lying to him about this. He has simply never asked the question in a way that would make him hear the answer — and it was never the council's question to answer in the first place, since none of the other four know there's a question at all.

*What the plan would actually require is not decided, and should stay that way for now.* The shape Oswald is circling, half-formed even to himself: his brother is the Scar, and the Scar has no single body to return — he's distributed across the whole of the In-Between, the way scar tissue doesn't have one edge. Oswald doesn't know that's what he's reaching for, only that removing Aurora and opening the Seat might not be enough by itself. Somewhere underneath the hope he won't let go of is a second, unexamined one: that opening the Seat paired with some ritual he hasn't found yet could do what removal alone can't — gather what's left of his brother back into someone, instead of just leaving an empty chair for the convergence to fill with whatever's nearest. What that ritual is, whether it's possible, and what "gathering back together" would even mean for a thing with no interior left, is unresolved on purpose. It's meant to be found at the table, not settled here.
...
**Oswald vs. almost everyone.** He's openly consolidating personal power while privately preparing another attempt on the Seat of Binding (The Pendragon Attempt, above). Every other original member has reason to watch him — Elara and Archibald both lose ground if he centralizes further, and Cedric's military loyalty is the prize he most wants and least fully owns. The letter hidden at Table #9 (`places/capital/gilded-tusk.md`) is addressed to Percival — a lead on the Prince's murder, not a direct warning about Oswald. Whether it ever reaches him, and where following it eventually leads, is a table discovery, not a settled fact.

**Elara vs. Archibald.** Open market against underground market. She tracks every coin that moves in the light; he owns the economy that moves in the dark. They need each other — goods bleed both ways — and resent each other for it. The Cellar Custodians sit in the middle of that friction; Cedric holding them against what comes up from below is what keeps either side from treating the tunnels as unclaimed territory. See `factions/the-cellar-custodians.md`.

**Cedric vs. Oswald.** Cedric commands the military proper — walls, gates, the Cellar Custodians against what comes up from below, and the Adventurers' Hall's irregulars extending Regency order into the surrounding territory (`places/capital/capital.md`, The Inner Precinct). He's the only council member who can put armed force on the street without asking anyone's permission — a martial-law power held in reserve, not the same thing as Archibald's day-to-day policing. Oswald needs that force loyal. Cedric hasn't fully given it.

**Eveline vs. the table.** She holds the Grid — never speaks, never votes. Everyone assumes neutrality. No one is certain of it, and no one at the table knows how recently the seat actually changed hands. The Grid answering to her office alone is still a quiet veto: any serious move against her risks the city's actual survival. See `factions/the-weavers.md`, The Source Chamber.
...
Tall, stiff-postured — not cold. Formal, but the kind of formal most people read as pleasant: he smiles when he approves, in council and behind closed doors alike, and subordinates who only ever catch him on a good day would call him nice. Nobody has ever needed to raise his volume for him; the rank does that.

**The flip is what's unsettling, not a constant undertone.** An order followed imperfectly reads to him as an order defied, and there's no rising heat to see coming — no visible tell between the smile and what replaces it. People who've watched it happen once do not require a second demonstration to stay exact.
...
**Belief:** an order that isn't executed exactly is the same as no order at all — precision is the one variable he can actually act on, and acting on it is the only thing keeping decades of unbroken work from coming apart.

**Wound:** whether a Seat's bearer can actually be removed against her will is not settled fact — the Seat of Love/Binding's own state (`world/seats.md`, Seat States) is **Contested**, "two beings fighting for a Seat warp reality until one wins." **Oswald would never call what happened at the Pendragon Attempt a failure, and he isn't wrong to refuse the word.** Aurora is bound beneath the city right now, the extraction running, the Weavers keeping the binding usable (`factions/the-weavers.md`) — to him that isn't aftermath or a consolation prize after losing. It's the same attempt, still executing, decades into itself, with the original moment as its opening move rather than its ending. Nobody knows what actually makes a bearer removable. Oswald's private account doesn't deny that uncertainty — he denies that it matters. His conclusion is that whatever is keeping Aurora bound instead of gone, somewhere in this enormous, still-running machine of binding and extracting and positioning, is precision, because that hands him a variable he can act on. The alternative — that the real variable might be something no amount of discipline touches, and the attempt could run another thirty years exactly as precisely as he can make it and still not remove her — is the one he's never let himself hold long enough to test. *(What finishing the job would actually mean to him is GM Secret — see The Pendragon Attempt, above: What Oswald Believes.)*

**Refusal:** not a refusal that Aurora is unremovable — nothing has told him that, and Contested says otherwise. His refusal is narrower and worse: he will not sit with not knowing what actually would remove her. Precision is the belief that lets him keep the attempt moving instead of standing still in front of a question with no answer.
