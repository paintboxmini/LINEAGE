...
They broke off because it was killing them, not because they'd lost outright — but they never finished what they'd started. **What survived the retreat was containment, not the Binding they'd actually reached for.** Aurora stayed chained to the throne they'd already built; the complete, structural version of the ritual — the one that would have made the kingdom eternal without anyone ever having to maintain it again — never finished. What was left standing over the following century is ordinary Holding instead: the Weavers' Grid, extraction paid piecemeal rather than bound whole (`factions/the-weavers.md`). An incomplete Binding, not a Binding that never started. Whether the throne they built became something more than a containment device in the century since is its own question (`world/seats.md`, Love/Binding) — none of the eight knew to ask it. They set out to bind an Archon. They didn't know what a convergence was, and never found out they'd caused one.
...
**What he's actually holding the throne open for is a completion, not a vacancy — and he has never once seen the difference.** Oswald isn't waiting for a Seat to come open so his brother can walk into it as king again. Underneath the plan he can say out loud, even to himself, is the plan the eight of them actually started: finish the Binding. Not suppress Aurora forever — replace her. He believes that once she's gone, his brother returns, the council is restored to who they were before the fight, and the kingdom stands exactly the way Pendragon originally wanted it: finished, eternal, no more Weavers, no more extraction, no more century of maintenance holding it up by hand. **What he doesn't see is that the Binding was never going to complete just because Aurora is removed. It completes because something takes her place.** If his plan ever worked exactly as he pictures it, his brother wouldn't be handed back a free throne — he'd be fused to the Loom the same way Aurora is now, the kingdom's new permanent anchor, not its returning king. Oswald has spent a hundred years solving for his brother's return without once solving for what a completed Binding actually requires of whoever anchors it. Nobody is lying to him about this. He has simply never asked the question in a way that would make him hear the answer.
...
**The ongoing attempt:**
The first fight broke off unresolved, not lost outright. The council has not stopped — though only one of them is actually still trying to finish it, and not for the reason the other four assume. Oswald isn't positioning himself to claim the Seat. He's positioning Aurora to be removable. Suppression was never the end state to him, only ever a stage toward it — chains, then the slow extraction (`factions/the-weavers.md`), then eventually, however long it takes, actually taking her out of the Seat rather than just holding her still in it. That removal is the completion he's actually chasing (What Oswald believes, above) — he's never separated "get Aurora out" from "finish what we started," because to him they're the same act. What "taking a Seat's bearer out" would even require, whether it's possible at all against a living, unwilling one, and what fills the space she leaves, is exactly the same unknown his Wound (below) refuses to sit with. Oswald's plan, referenced in the letter at Table #9 of the Gilded Tusk, is real — but the letter reads it as a threat to the other council members, and that may not be wrong so much as incomplete. Whether finishing what he's actually after costs the other four something neither they nor whoever wrote that letter has reckoned with is an open thread, not a settled fact.
