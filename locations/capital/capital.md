...
**Magistrate Ambrose** presides and believes impartiality only means something if it costs the powerful something too — a ruling that never once inconveniences someone with real power isn't impartial, it's just quiet favor with better paperwork. Ruled against Isabella once, on a contract technicality she clearly hadn't expected to lose on, and has watched her come back more often since rather than less — whether that's respect, curiosity, or research is a question he's decided isn't his to answer from the bench. He's also, privately, ruled *for* power under real pressure exactly once, years before that, and has been trying to prove to himself he isn't that judge anymore ever since. He'd never say which ruling is more honestly him.
