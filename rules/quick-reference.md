...
**Tie** → no damage, no bonuses

---

## Card Anatomy

**Name / Color — Stat / Attack: Stat + die / Effect / Defensive Bonus / Range / Flavor**
...
| Range Term | Meaning |
|------------|---------|
| Melee | You and the target must both be in Frontline |
...
|------|----------|--------|-------|
| Short | 20 min | 1d6 + Body HP | 3/day |
| Long | 7½ hours | Full heal | Once/day |
...
While behind partial cover, roll 1d2 before defending. On a 1, the attack misses entirely.
...
Only equipped items have permanent passive effects. Carried items can be used via the Interact action. Artifacts are resonant jewelry aligned with a Seat's domain.
