...
Your stats, then how combat and exploration actually work at the table. The rest of character creation — background, and how the starting deck gets drafted — lives in `rules/character-creation.md`.
...
Full mechanics — positioning, turn structure, attack resolution, damage, reading a card, status effects, collapse and death — live in `rules/combat.md`. Read that for how a fight actually works.

How much you get to decide about what a card looks like when you play it: `rules/character-creation.md`, Magic Expression.

---

# Part Two: Exploration

Checks, saves, perception, and Advantage/Disadvantage outside of combat: `rules/resolution.md`.
...
Short and long rest durations, limits, and what they clear: `rules/character-creation.md`, Resting.

## Equipment

Slots, what carries a permanent effect, and the full item catalog: `rules/character-creation.md` (Equipment), `rules/equipment.md`, and `rules/items.md`.
