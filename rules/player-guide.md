...
**Unguarded** — some creatures and people don't fight until they're fought. They take no turns and play no cards, which leaves you an opening. You get one of two things, never both: **strike**, and one attack lands unblocked (no defense, no reveal — though Evade and Immunity still apply, they're unaggressive not helpless), or **ready** yourself visibly, which drops Unguarded with no attack. Either way initiative follows. This isn't an ambush and doesn't stack with one: an ambush pays for not being seen and beats Evade and Immunity; this doesn't.
