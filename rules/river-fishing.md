...
**The bite is a real-time surprise, not a turn.** Once a line's cast, the GM privately decides when the fish takes it — could be thirty seconds, could be the whole rest of the scene, whatever fits the moment. When it happens, the GM calls it out loud, immediately, with two things at once: a stat (Mind, Body, or Soul — the GM's pick, semi-random, leaning toward whichever hasn't come up in a while so the same player isn't fishing every time) and the fact that the fish is on.
...
The randomness of *when* is what makes it land — nobody can prep for a check they don't know is coming, so the roll that matters is the one made under a little real pressure, not the one made with time to think. That's the whole joke and the whole point at once.
