...
- **A deck** — 3 themed signature cards plus 4–7 core cards, 7–10 total (see `rules/cards.md`, Deck Building). Enemies draw to hand size (Mind, minimum 2) like everyone else.
