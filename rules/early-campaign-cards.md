...
- **Lifesteal and Quick are still at zero in both printed sets.** Lifesteal is eligible again but unseated: its three cards are Red, Red and Green, so nothing about being legal gets Blue a Lifesteal card. Quick was never in the expansion at all. Blind, Ward and Vulnerable came back — PARRY, FOCUSED STANCE and PROFILE's rewrite covered them. Filling either gap means a swap or a new card, and it is not obvious either is owed a seat.
