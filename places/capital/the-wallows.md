...
*The mine beneath Eclipseria.*

## The Mine Knows

Everything in the Wallows holds on longer than it should. Sound doesn't dissipate — it layers. Tunnels narrow behind you. The stone is warm in places it has no business being warm.
...
| Layer | What it is |
|-------|-----------|
| **The Waterworks** | Citywide utility layer, not specific to the mine — runs beneath the entire capital. The Bazaar & Tavern is a small, hidden pocket inside it, not its own level. |
...
Functional. Brutal. The Demon Court runs it like a court in miniature — ranks enforced, hierarchy visible, the Warden's authority performed at every shift change.

Workers are debt slaves. A low warmth settles into the bones here, a patience that doesn't belong to the people feeling it. The Warden keeps his operation at the precise depth where that warmth is an asset. Deep enough to quiet resistance. Not so deep that the workers stop wanting to work.
...
She is chained to it. Her hair spills out from her in every direction, threaded directly into the Grid that runs beneath every district above. This is not a metaphor players are meant to intuit. It is the literal shape of the Seat: Aurora fused to a throne built to hold her, in the one place built to hold both.
