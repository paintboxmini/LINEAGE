...
Farmland on Turnroot Weald's eastern edge, cut a little way into the forest itself — not a town, a claim. Two days inland from the Unheld shoreline by way of the Roadhouse (`quests/washed-ashore.md`), and a long road from anywhere else. Red dirt roads, waist-high wood fences, wet fields, old watchtower ruins holding the line where the fields stop and the Weald starts. The kind of place that has been here long enough to stop explaining itself.
...
Off the road on the way in, set back far enough that the party has to choose to walk to it. Gray boards, gray sky, gray fence line — from the road it reads as one more Briarwatch farmhouse, because that's what it is. The difference shows well before anyone reaches the fence: nothing is maintained, and nothing is looted.

**What's here** (state these flatly, don't connect them for the party):
- The fences are broken outward, every break, the whole perimeter — the posts lean away from the house.
- The well is caved in — not filled, not boarded, collapsed inward, the stones gone down after whatever gave way beneath them. The ground around it is soft.
- Four briarbundles still stand in the fields, weathered down to armature and wire. Nobody took them down. Nobody in Briarwatch ever does.
- Two of the bundles are new — fresh thorn cuttings, fresh twine, fenwool that hasn't gone gray yet. Tied within the season, at a house nobody's lived in for years.
- A child's doll, made of fenwool, rain-flattened, in the yard between the door and the well.
- The door is open, and has been long enough that the floor inside is weathered in a band where the light reaches.
...
Well past the last field, out past the watchtower ruins — Briarwatch keeps its farmland and its Fenwool back from the Turnroot border on purpose, and everyone here knows better than to graze anything close to it. A party standing at the ruins can already make out its scale before they've walked it.

Not a farmer's fence — squared stone posts, evenly set, standing several times the height of a man, an old, careful, oversized piece of work. Nobody in Briarwatch remembers who built it or why the border sits exactly here (the Masons did, same project as the watchtower — see this file's own GM Secret, above). Thick cable runs post to post, but the cable itself doesn't match the posts: bramble and thorn worked into uneven, layered snarls, hooked back on themselves like fishhooks, built to hold what they catch. It doesn't take long watching a Tollbird return to the same stretch of cable, thorn-brush already in its claws, to work out who's been doing that part.
...
**Getting Barbed:** moved onto the fence by an effect you didn't choose yourself, you're hooked — 1 unpreventable damage immediately, no roll. Moving there under your own power never hooks you. While Barbed: every attack you make tears it (1 unpreventable damage), every successful block tears it (1 unpreventable damage), and freeing yourself tears it once more, whether you leave Frontline or work the barb loose in place. This is encounter-specific terrain language, not a global keyword.

**The turn against the Tollbirds:** Pull a perched Tollbird down onto its own cable, on the party's timing, and the barbs belong to them for once.

**Running it:** let the first dive hurt. Let the first swing at a perched Tollbird waste itself on Evade. Let the table notice the grounded one standing open with nothing in its claws — don't explain the window, the wheel is on the table and the players will find it. Reward a Wait-to-reposition visibly. Don't point out the Pull-them-onto-their-own-barbs trick; let someone try it once and feel clever.
