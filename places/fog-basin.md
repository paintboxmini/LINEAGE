...
Rebuilt on the site of one that burned — real, operating, takes children with nowhere else to go (`quests/sour-tomatoes.md`, Where the Kids Go). Steele grew up in the original and was inside when it burned. He got out. **Not everyone did.** He rebuilt it himself later, on the same ground. A longer trip for anyone bringing children here from elsewhere in the basin, but a standing answer, not an open question.

*Steele was a player character (Kevin), retired to `archives/steele/README.md`. The orphanage is not retired with him — it stands on its own here, and is the place to build if his story comes back.*

---

## Pell

Small, ancient, deeply unbothered. Found in the basin with a lantern and a coat with too many pockets.

He sells fog goggles. He charges differently for each customer — not in gold. In something personal. A memory. A secret. A name they haven't used in years.

*The price is always exactly what that person can afford to lose.*

He doesn't explain the goggles fully. He doesn't explain the lanterns at all. He just rummages in the coat and hands something over like it's nothing.

Fogcallers don't attack him. He leaves offerings at certain fog-line junctions — something small, something traded — and the birds take them and go. He's not controlling them. He learned the etiquette.

If asked why the birds leave him alone:

> *"Everything eats something. Everything listens to something. Fogcallers just happen to listen to trade."*

Then he adjusts the lantern and keeps walking.

**Pell's inventory:** See `items/fog-basin-items.md`.

---

## Appalachian Correspondence (GM Context)
