...
**"River dogs"** — their own term for themselves, not an outsider's name for them. The insults are riffs off it instead, twisted just enough to sting: **"watermutt"** is the common one, trading "river" for the vaguer, dirtier "water" and "dog" for "mutt" in the same breath — cutting the river tie and the pedigree both at once.
