...
- **Briarwatch** (`locations/briarwatch.md`) — everything about the place traces back to one fact: this farmland was cut a little way into Turnroot Weald's own territory, and hasn't stopped showing it. The displaced wildlife (Jackalopes in the watchtower ruins, Scratchers in the hedgerows), two fences built of two different materials for two opposite reasons (wood, waist-high, to keep the Fenwool in; stone, oversized, to keep the Weald out), a GM Secret that only hides what's genuinely unknowable (who built the perimeter) while leaving what's plainly observable (the Tollbirds thorned it over themselves) for players to notice on their own — none of it reads as separately invented texture. It's one piece of ecology worked all the way through.

## Candidates — proposed, not yet confirmed

- **Weck** (`experimental/the-man-who-buys-wounds.md`) — an NPC whose mechanic (permanently removing a Wound for coin and a name in his ledger) *is* his character; nothing about him is explained, only enacted.
