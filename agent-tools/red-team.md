...
1b. Design Principles fit.
   ...
   Check against `agent-tools/design-principles.md` directly — this is a
   design standard, not an engine check, and violating it doesn't break
   anything the simulator would catch.
