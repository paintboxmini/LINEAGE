...
*The Shunka's ancient enemy, and the people responsible for the royal curse — kept in `experimental/` alongside `campaign/the-shunka.md` until it settles.*
...
**Why they invaded.** Their ground was thin — literally, physically small, not metaphysically unstable. Price isn't a foregrounded, actively-managed risk in this world; it's paid constantly and automatically just by being alive (breathing, eating, sleeping, dying and feeding what comes after — the Three Cuts are the cosmology's baseline, but day-to-day stability actually comes from the Seats, not from anyone keeping a ledger on whether the world's about to blink out). A small island was never in danger of ceasing to exist. It was just small, and got smaller — a natural disaster, or the river itself reshaping the land over generations, could easily account for it. Not glory, not tribute — they needed somewhere else to stand, and the Shunka had ground worth taking. The full war and the curse that came out of its failure: `campaign/the-shunka.md`.
...
**Ecosystem.** A river people, not a coastal one. They hold an island off the **lower east coast of the Shunka island**, both of them river-web islands in the web's northernmost reaches rather than sea islands (`world/geography-overview.md`, Bearing Table) — which is what put the two peoples in each other's way to begin with, and why a people this at home in water were ever neighbours to a people who aren't. Almost entirely aquatic diet, built around what the river actually provides. Their island being small was survivable for a people this at home in water; the same island with the river's own catch running thin was the actual crisis, not the ground itself failing.
...
**Survivors exist, and they haven't given up.** Not extinct — a remnant, but not a broken one. It's been generations since the invasion (`campaign/the-shunka.md`, What's Open — When it happened), and they've spent that time rebuilding a real army, not just surviving. They're waiting for the moment to strike the Shunka again. The land problem that started the first war was never solved — they still need ground that isn't theirs, and that's still part of why the Shunka specifically.

**Closed off, and hostile.** A people who don't trade, don't open their islands to outsiders, and treat contact as threat first. Consistent with a people actively preparing for a second war rather than a scattered, harmless remnant.

## What's Open

**Whether the curse-technique survived her.** It did — it was never hers alone, it is her family's, taught inside the bloodline and to nobody else (`factions-and-races/races-lizardkin.md`, The Cursegivers). The original cursegiver paid her own existence to force the Price onto the Shunka queen's line (`campaign/the-shunka.md`) — she's gone, not just dead, unmade entirely. Given they're rebuilding an *army* this time rather than being described as rebuilding their magic, one live possibility: they learned from losing to the Shunka's own strength and are coming back to win that way instead, not repeat a one-time horror they may not even be able to repeat. Not decided — just as easily could be both.

## Related Documents

- `campaign/the-shunka.md` — the war, the curse, what it did to the Shunka royal line
- `world/creation-myth-the-three-cuts.md` — the Second Cut, Price, and the Tithe's resonance with it
- `world/geography-overview.md` — the mapped continent, the river web
- `campaign/pat.md`, `campaign/pat-cards.md` — Pat's own connection to this history
