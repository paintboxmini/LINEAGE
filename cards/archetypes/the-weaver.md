...
*"makes unrelated mechanics interact... turns two average cards into one powerful interaction" (example: AXIOM + PARADOX). Question: *what can I connect?* Not yet built toward.*
...
*None yet. A named-but-unbuilt archetype is a real, open gap — not a mistake (`agent-tools/archetypes.md`).*
