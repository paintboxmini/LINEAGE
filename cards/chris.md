...
The three custom cards Chris starts with. See `campaign/chris.md` for the
...
- `campaign/chris.md` — the character, the stats, and the case for each card
- `campaign/passives.md` — AMALGAMOUS FORM and MIMETIC BLADE, his Passives
- `rules/card-glossary.md` — Deadly (17), Armour (0)
