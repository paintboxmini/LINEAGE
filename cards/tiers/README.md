...
**Coverage.** All 166 cards in the three core colour lists were screened on 2026-09-17: 128 cleared, 38 in the middle tier, and one — ABANDON — cut outright. That is the core pool only; creature and character cards in the other `cards/*.md` files have never been screened and mostly should not be, since players do not draw from them.
