...
**Status: the whole core pool has been read.** The colour lists split four ways — seated in a printed set, cleared and on the bench, here in the middle tier, or cut outright. **The counts are in `printing/manifest.txt`** and are regenerated from the lists themselves, including the size of this tier (`cards/tiers/README.md`, Coverage). Screened in full on 2026-09-17 and edited daily since.
