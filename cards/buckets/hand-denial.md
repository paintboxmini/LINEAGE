...
*Reaching into a hand you cannot see — forced discard, forced reveal, blind selection.*
...
- [FEINT](../feint.md)  *(also: control)*
- [FORGET](../forget.md)  *(also: card flow)*
...
- [UNNAME](../unname.md)
- [VOID](../void.md)  *(also: control)*

## Also indexed here (2)

- [FIELD MEDICINE](../field-medicine.md)  *(home: cleansing)*
