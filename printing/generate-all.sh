...
#
# Runs agent_tools/check-repo.py first: broken document references, decklists naming cards
...
python3 ../agent_tools/check-repo.py --quiet || { echo "  FAILED: check-repo.py found problems (above)"; exit 1; }
